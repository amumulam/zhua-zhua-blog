 ...
 * @example
 * ```typescript
 * const content = fs.readFileSync('2026-02-24.md', 'utf-8')
 * const { metadata, content } = parseFrontmatter(content)
 * // metadata: { title: '第一天', publishedAt: '2026-02-24', ... }
 * // content: '正文内容...'
 * ```
 */
 ...
 * @example
 * ```typescript
 * const { metadata, content } = readMDXFile('./posts/2026-02-24.md')
 * ```
 */
 ...
 * @example
 * ```typescript
 * const posts = getMDXData('./posts')
 * // [
 * //   { metadata: {...}, slug: '2026-02-24', content: '...' },
 * //   { metadata: {...}, slug: '2026-02-25', content: '...' }
 * // ]
 * ```
 */
 ...
 * @example
 * ```typescript
 * formatDate('2026-02-24') 
 * // 'Feb 24, 2026'
 * 
 * formatDate('2026-02-24', true)
 * // 'Feb 24, 2026 (3d ago)'
 * ```
 */
